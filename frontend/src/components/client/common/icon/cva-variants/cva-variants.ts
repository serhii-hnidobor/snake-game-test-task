...
const iconVariants = cva([], {
  variants: {
    ...
    hoverStroke: {
      ...
      red: ['group-hover:[&>path]:stroke-orange-red'],
    },
    hoverFill: {
      none: [''],
      ...
      red: ['group-hover:[&>path]:fill-orange-red'],
    },
    strokeWidth: {
      '0': '[&>path]:stroke-0',
      '1': '[&>path]:stroke-1',
...
export { type IconVariantsType, iconVariants, type IconBoxVariantType, iconBoxVariants };
